module cb_dqh(
    ...
    // 3. Khối Huffman cho Cb (Lưu ý: Có phép vị tự/Transpose ma trận Qij -> Cji như bản gốc)
    chroma_huff u_huff(
        .clk(clk), .rst(rst), .enable(quantizer_enable), 
        .C11(Q11), .C12(Q12), .C13(Q13), .C14(Q14), .C15(Q15), .C16(Q16), .C17(Q17), .C18(Q18), 
        .C21(Q21), .C22(Q22), .C23(Q23), .C24(Q24), .C25(Q25), .C26(Q26), .C27(Q27), .C28(Q28),
        .C31(Q31), .C32(Q32), .C33(Q33), .C34(Q34), .C35(Q35), .C36(Q36), .C37(Q37), .C38(Q38), 
        .C41(Q41), .C42(Q42), .C43(Q43), .C44(Q44), .C45(Q45), .C46(Q46), .C47(Q47), .C48(Q48),
        .C51(Q51), .C52(Q52), .C53(Q53), .C54(Q54), .C55(Q55), .C56(Q56), .C57(Q57), .C58(Q58), 
        .C61(Q61), .C62(Q62), .C63(Q63), .C64(Q64), .C65(Q65), .C66(Q66), .C67(Q67), .C68(Q68),
        .C71(Q71), .C72(Q72), .C73(Q73), .C74(Q74), .C75(Q75), .C76(Q76), .C77(Q77), .C78(Q78), 
        .C81(Q81), .C82(Q82), .C83(Q83), .C84(Q84), .C85(Q85), .C86(Q86), .C87(Q87), .C88(Q88),
